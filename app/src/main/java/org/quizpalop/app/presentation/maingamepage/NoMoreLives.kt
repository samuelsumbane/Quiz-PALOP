...
import org.quizpalop.app.presentation.composables.HorizontalDividerWithText
import org.quizpalop.app.presentation.composables.RowCoinAndText
import org.quizpalop.app.presentation.composables.RowHeartAndLives
import org.quizpalop.app.presentation.composables.VerticallyCenteredRowAndSpacedBetween
import org.quizpalop.app.presentation.composables.verticallyCenteredRowContent
...
//                        HorizontalDivider(Modifier.fillMaxWidth())
            ...
            if (quizGameUiState.lastDateTimeLostLives > 0L) {
                when {
                    ...
                    hours >= 2 && quizGameUiState.lives == 0 -> {
                        gameQuizViewModel.changeLivesCount(ChangeLifeCountValues.IncreaseLives(1))
